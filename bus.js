...
function showResponse(h) { 
    ...
    if(h === null){
        ...
        for(var i = 0; i < jsonObj[0].values.length; i++){
            ...
            direction.setAttribute('class', 'col-xs-2 col-md-3');
            ...
            minutes.setAttribute('class', 'col-xs-2 col-md-3');
            ...
            seconds.setAttribute('class', 'col-xs-2 col-md-3');
            ...
            busid.setAttribute('class', 'col-xs-2 col-md-3');
